...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content
      >An unexpected error has occurred and the Catalogue needs to reload. We
      apologise for this inconvenience. This error has been reported. Maybe send
      Michael a message</mat-dialog-content
    >
    <mat-dialog-actions>
