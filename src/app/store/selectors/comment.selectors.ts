...
export namespace CommentSelectors {
  ...
  export const count = createSelector(commentState, (state) => state.count);
  export const getIds = createSelector(commentState, (state) => state.ids);
  ...
  export const commentsForRelease = (releaseId: string) => {
    return createSelector(commentState, (state) => {
